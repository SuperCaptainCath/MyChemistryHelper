 ...
 * @author Elliot
 */
public class MoleToMassViewController implements Initializable {
    ...
    @FXML
    private TextField numMolesField;
    @FXML
    ...
    private void switchMode(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("MassToMoleView.fxml"));     
        Scene scene = new Scene(root);  
        
        Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        stage.setTitle("Mass-to-Mole Converter");
    ...
    private void convert(ActionEvent event) {
        ...
        double answer = Integer.parseInt(numMolesField.getText()) * totalMolarMass;
